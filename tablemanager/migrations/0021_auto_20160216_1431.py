    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.SlugField(help_text='Name of Publish', unique=True, max_length=255, validators=[django.core.validators.RegexValidator(re.compile('^[a-z0-9_]+$'), 'Slug can only contain lowercase letters, numbers and underscores', 'invalid')])),
        ...
        migrations.AddField(
            model_name='publish',
            name='default_style',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL, to='tablemanager.PublishStyle', null=True),
